...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let loginStory : UIStoryboard = UIStoryboard(name: "Login", bundle: nil)
        let loginPage : UIViewController = loginStory.instantiateViewController(withIdentifier: "Login")
...
//        window?.rootViewController = navController
    ...
    func application(_ application: UIApplication, open url: URL, sourceApplication: String?, annotation: Any) -> Bool {
        let handeled : Bool = FBSDKApplicationDelegate.sharedInstance().application(application, open: url, sourceApplication: sourceApplication, annotation: annotation)
        return handeled
    }
}
